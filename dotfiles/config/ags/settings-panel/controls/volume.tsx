...
import { LevelSlider, PanelCard } from "../primitives"

/**
 * Sound volume.
 *
 * Reads/writes via the AstalWp (require 0.1) default speaker. The slider writes
 * `volume`; clicking the leading speaker glyph toggles `mute`. The glyph is
 * level-aware and resolved through the shared icon registry; the initial
 * assignment happens inside `createEffect` so the first render is correct.
 *
