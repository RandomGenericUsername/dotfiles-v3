...
from icon_templates_renderer.domain.models import PathOverrides, RenderRequest
...
def render_command(
    ...
    overrides: PathOverrides = build_overrides(template_dir, color_scheme, output_dir)
