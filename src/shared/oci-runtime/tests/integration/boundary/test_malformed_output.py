...
class TestMalformedInspect:
    def test_inspect_malformed_json_raises_not_found(self, transport, caps):
    ...
    def test_inspect_malformed_json_image(self, transport, caps):
        transport._responses = {"docker image inspect alpine": ExecResult(returncode=0, stdout=b"not json", stderr=b"")}
    ...
    def test_inspect_malformed_json_volume(self, transport, caps):
        transport._responses = {"docker volume inspect myvol": ExecResult(returncode=0, stdout=b"not json", stderr=b"")}
