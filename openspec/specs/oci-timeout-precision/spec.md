# oci-timeout-precision Specification

## Purpose
CLI timeout values are rendered via ceil using the cli_seconds helper to ensure fractional timeouts are never under-applied.
## Requirements
