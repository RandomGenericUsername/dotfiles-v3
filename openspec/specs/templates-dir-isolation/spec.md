# templates-dir-isolation Specification

## Purpose
TBD - created by archiving change templates-dir-isolation. Update Purpose after archive.
## Requirements
### Requirement: Templates directory is isolated from settings assembly

Templates directory resolution SHALL be managed exclusively by `TemplateDirResolver` (path resolution subsystem). The settings assembly subsystem SHALL NOT have any knowledge of templates directory.
