...
- [ ] Task 7 — Full green gate (AC: all)
  - [ ] `uv run --directory src/runtime pytest -q` (baseline **353 passed, 2 skipped** — includes the 4 rt-2-5 review-patch tests; expect +N from this story)
  ...
  - [ ] `tests/architecture/test_layering.py` green (adapter lives in adapters/; no new import categories)
